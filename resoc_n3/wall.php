...
<body class="bg-gray-200">
    ...
    <div class="flex">
        <aside class="w-1/4 bg-white p-4 border-r-2 border-gray-300">
            ...
            <p>Vous retrouvez ici tous les messages postés par Félicie, dont l'id est 123</p>
        </aside>
        <main class="w-3/4 p-4">
            <!-- Message items should be repeated as per the content in the screenshot -->
            <div class="mb-4">
                <div class="flex justify-between mb-2">
                    <span class="text-xs">1 décembre 2020, 11h12</span>
                    <span class="text-xs">par Félicie</span>
                </div>
            ...
            <!-- Repeat the above block for each message, changing the date, author, and content accordingly. -->
        </main>
    </div>
</body>
