...
<head>
    ...
    <title>Félicie's Subscriptions</title>
...
<body class="bg-gray-200">
    ...
    <div class="flex">
        <aside class="w-1/4 bg-white p-4 border-r-2 border-gray-300">
            ...
            <p>Vous retrouvez ici la liste des personnes dont Félicie (dont l'id est 123) suit les messages.</p>
            <ul class="mt-4">
        ...
        <main class="w-3/4 p-4 grid grid-cols-3 gap-4">
            <!-- Subscription items should be repeated as per the content in the screenshot -->
            <div class="border-2 border-black p-2 text-center">
                <img src="https://placehold.co/80x80" alt="Ada profile placeholder" class="mb-2 mx-auto">
                <p>Ada</p>
            </div>
            <div class="border-2 border-black p-2 text-center">
                <img src="https://placehold.co/80x80" alt="Alexandra profile placeholder" class="mb-2 mx-auto">
                <p>Alexandra</p>
            </div>
            <div class="border-2 border-black p-2 text-center">
                <img src="https://placehold.co/80x80" alt="Zoe profile placeholder" class="mb-2 mx-auto">
                <p>Zoe</p>
            </div>
            <!-- Repeat the above block for each subscription, changing the name and placeholder image alt text accordingly. -->
        </main>
    </div>
</body>
