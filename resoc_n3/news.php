...
<body class="bg-gray-200">
    ...
    <div class="flex">
        <aside class="w-1/4 bg-white p-4 border-r-2 border-gray-300">
            <img src="https://placehold.co/100x100" alt="User profile placeholder image" class="mb-4">
            <p>Vous retrouvez ici les derniers messages de tous les membres</p>
        </aside>
        <main class="w-3/4 p-4">
            <!-- News items should be repeated as per the content in the screenshot -->
            <div class="mb-4">
            ...
            <!-- Repeat the above block for each news item, changing the date, author, and content accordingly. -->
        </main>
    </div>
</body>
