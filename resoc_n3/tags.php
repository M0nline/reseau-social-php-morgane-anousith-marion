...
<body class="bg-gray-200">
    ...
    <div class="flex">
        <aside class="w-1/4 bg-white p-4 border-r-2 border-gray-300">
            <p>Vous retrouvez ici les derniers messages comportant le mot clé "Lorem" (dont l'id est 996)</p>
        </aside>
        <main class="w-3/4 p-4">
            <!-- Tagged message items should be repeated as per the content in the screenshot -->
            <div class="mb-4">
            ...
            <!-- Repeat the above block for each tagged message, changing the date, author, and content accordingly. -->
        </main>
    </div>
</body>
